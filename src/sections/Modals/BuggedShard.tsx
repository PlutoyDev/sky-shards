...
export function ShardIsBuggedModal({ hideModal }: ModalProps) {
  return (
    <div className='my-2 flex max-h-full w-full flex-col flex-nowrap items-start justify-center gap-y-2'>
      ...
      <p>You are seeing this as pop-up because shard is currently bugged in-game or schedule of shard had changed.</p>
      <p>There the countdown/clock prediction here might not reflect what is in game</p>
      <p>
